...
export const weaponSlugToSlot: Record<string, string> = Object.fromEntries(
  Object.entries(weaponSlotSlugs).map(([slot, slug]) => [slug, slot])
);
...
export const armorSlugToSlot: Record<string, string> = Object.fromEntries(
  Object.entries(armorSlotSlugs).map(([slot, slug]) => [slug, slot])
);
